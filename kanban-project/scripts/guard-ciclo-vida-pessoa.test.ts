...
const AUTORIZADOS_FORA_DO_RUNTIME: Record<string, string> = {
  ...
  "scripts/teste-reconciliacao-4-passos.ts":
    "teste da reconciliação de dados (mandato Emissão Documental, 14/09/2026): cria a " +
    "PRÓPRIA árvore/pessoas (marca RECONC4P) só no banco de teste — nenhuma pessoa é " +
    "removida por este teste",
  ...
  "scripts/minha-operacao-semantica.test.ts":
    ...
    "humanização de risco, filtros server-side e EMI-021/022 — cria a PRÓPRIA árvore/" +
    "pessoas (marca MINHAOP-SEM) só no banco de teste — nenhuma pessoa é removida por este teste",
  ...
  "scripts/prova-pasta-documental-linha-do-tempo.test.ts":
    "mandato 'pasta única, uma linha do tempo, não documento por documento' (24/09/2026): " +
    "cria as PRÓPRIAS árvores/pessoas (marca PASTALINHATEMPO) só no banco de teste — a limpeza remove " +
    "só o que o próprio teste criou (deleteMany direto, desmontar o próprio cenário sintético)",
