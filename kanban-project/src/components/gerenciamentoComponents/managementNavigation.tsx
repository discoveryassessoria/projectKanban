...
export const MANAGEMENT_NAVIGATION: ManagementNavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      a(20, "pricingtable", "Tabelas de Preços", ["preco", "preço", "tabela", "valor"]),
      a(30, "pricing", "Aplicabilidade Econômica", ["preco", "preço", "aplicabilidade", "economica"]),
      a(40, "discrules", "Regras de Precificação", ["preco", "preço", "regra", "desconto", "economica"]),
      a(50, "suppliers", "Fornecedores", ["fornecedor", "parceiro", "cartorio", "tradutor"]),
      a(60, "categories", "Categorias Financeiras", ["categoria", "financeiro"]),
      a(70, "coa", "Plano de Contas", ["plano", "conta", "contabil"]),
      a(80, "costcenters", "Centros de Custo", ["centro", "custo"]),
      a(90, "accounts", "Contas Bancárias", ["conta", "banco", "bancaria"]),
      a(100, "banks", "Bancos", ["banco"]),
      a(110, "wallets", "Carteiras de Recebimento", ["carteira", "recebimento"]),
      a(120, "currencies", "Moedas", ["moeda", "cambio", "câmbio"]),
      a(130, "fx", "Câmbio", ["cambio", "câmbio", "cotacao", "moeda"]),
      a(140, "methods", "Formas de Pagamento", ["forma", "pagamento"]),
      a(150, "paycond", "Condições de Pagamento", ["condicao", "condição", "pagamento", "parcelamento"]),
      a(160, "fees", "Taxas de Pagamento", ["taxa", "pagamento"]),
      a(170, "taxes", "Impostos", ["imposto", "tributo"]),
