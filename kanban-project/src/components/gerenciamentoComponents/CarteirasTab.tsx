    ...
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-[var(--text-secondary)]">Onde o cliente paga (Pix, gateway, boleto, transferência).</p>
        </div>
          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="bg-[var(--surface-primary)]">
                <th className="border-b border-[var(--border-default)] px-4 py-2.5 text-left text-[11px] font-semibold uppercase tracking-wide text-[var(--text-secondary)]">Carteira</th>
                <th className="border-b border-[var(--border-default)] px-4 py-2.5 text-left text-[11px] font-semibold uppercase tracking-wide text-[var(--text-secondary)]">Conta vinculada</th>
                <th className="border-b border-[var(--border-default)] px-4 py-2.5 text-left text-[11px] font-semibold uppercase tracking-wide text-[var(--text-secondary)]">Moeda</th>
                <th className="border-b border-[var(--border-default)] px-4 py-2.5 text-right text-[11px] font-semibold uppercase tracking-wide text-[var(--text-secondary)]">Liquidação</th>
              ...
              {filtradas.map((c) => (
                <tr key={c.id} className="border-b border-[var(--border-subtle)] last:border-0 hover:bg-[var(--surface-primary)]">
                  <td className="px-4 py-2.5">
                    ...
                    <div className="text-[11px] text-[var(--text-muted)]">{tipoLabel(c.tipo)}</div>
                  </td>
                  ...
                  <td className="px-4 py-2.5">
                    <div className="flex flex-wrap items-center gap-1.5">
                      ...
                      {c.isDefault && <span className="rounded px-2 py-0.5 text-[11px] font-medium bg-emerald-50 text-emerald-700">Padrão</span>}
                    </div>
                  </td>
                  <td className="px-4 py-2.5">
