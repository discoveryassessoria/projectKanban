                ...
                <tr key={m.id} className="border-b border-[var(--border-subtle)] last:border-0 hover:bg-[var(--surface-primary)]">
                  ...
                  <td className="px-4 py-2.5">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button onClick={() => excluir(m)} className="rounded-md border border-[var(--border-default)] px-2.5 py-1 text-xs text-red-700/80 transition hover:bg-[var(--surface-secondary)] hover:text-red-700">Excluir</button>
                    </div>
                  </td>
                </tr>
              ))}
