...
const FONTES: Fonte[] = [
  ...
  { chave: "categorias", nome: "Categorias Financeiras", modulo: "Financeiro", url: "/api/gerenciamento/categorias", raiz: "categorias" },
  { chave: "plano-contas", nome: "Plano de Contas", modulo: "Financeiro", url: "/api/gerenciamento/plano-contas", raiz: "contas" },
  { chave: "centros-custo", nome: "Centros de Custo", modulo: "Financeiro", url: "/api/gerenciamento/centros-custo", raiz: "centros" },
