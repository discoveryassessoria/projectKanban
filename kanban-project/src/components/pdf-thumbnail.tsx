...
export function PDFThumbnail({ url, className }: PDFThumbnailProps) {
  ...
  if (!isClient) {
    return (
      <div className={`flex items-center justify-center bg-gray-100 ${className}`}>
        <div className="w-12 h-14 bg-red-600 rounded-sm flex items-center justify-center text-[var(--text-primary)] text-xs font-bold animate-pulse">
          PDF
        </div>
      </div>
    )
  ...
  if (error) {
    return (
      <div className={`flex items-center justify-center bg-gray-100 ${className}`}>
        <div className="w-12 h-14 bg-red-600 rounded-sm flex items-center justify-center text-[var(--text-primary)] text-xs font-bold">
          PDF
        </div>
      </div>
    )
