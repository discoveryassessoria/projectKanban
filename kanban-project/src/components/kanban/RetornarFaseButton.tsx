  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 bg-[var(--app-background)] text-[var(--text-primary)] text-[12.5px] font-bold px-3.5 py-2 rounded-lg hover:bg-[var(--surface-secondary)] transition-colors"
      >
        ...
        <div className="fixed inset-0 z-[80] flex items-center justify-center bg-[var(--overlay-modal)] p-4" onClick={() => !enviando && setAberto(false)}>
          <div className="max-w-md w-full rounded-2xl bg-[var(--surface-popover)] p-6 shadow-[var(--elev-3)]" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex justify-end gap-2">
              ...
              <button disabled={enviando} onClick={() => void enviar()} className="inline-flex items-center gap-1.5 px-3.5 py-2 text-[12.5px] font-bold rounded-lg bg-[var(--app-background)] text-[var(--text-primary)] hover:bg-[var(--surface-secondary)] disabled:opacity-50">
