    ...
    >
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="space-y-2">
          <div className="h-7 w-64 animate-pulse rounded bg-[var(--surface-primary)]" />
          <div className="h-4 w-48 animate-pulse rounded bg-[var(--surface-primary)]" />
          <div className="h-4 w-56 animate-pulse rounded bg-[var(--surface-primary)]" />
        </div>
        <div className="h-10 w-full animate-pulse rounded-lg bg-[var(--surface-primary)] lg:w-96" />
      </div>
